...
<body>
    ...
    <div class="container">
        <div class="panel panel-default">
            ...
            <div class="panel-heading">/homecolor/index.php/Admin/Topic</div>
            <div class="panel-body">
                <p>分类展示页面，可以查看，修改，删除分类</p>
            </div>
            <table class="table table-bordered table-condensed">
                <tr>
                    <th>序号</th><th>名称</th><th colspan="2">操作</th>
                </tr>
                <?php if(is_array($topics)): $i = 0; $__LIST__ = $topics;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$it): $mod = ($i % 2 );++$i;?><tr>
                        <td><?php echo ($it["id"]); ?></td>
                        <td><?php echo ($it["name"]); ?></td>
                        <td><a href="<?php echo U('Admin/Topic/delete?id='.$it['id']);?>"><i class="glyphicon glyphicon-check"></i> 删除</a></td>
                        <td><a href="<?php echo U('Admin/Topic/input?id='.$it['id']);?>"><i class="glyphicon glyphicon-check"></i> 修改</a></td>
